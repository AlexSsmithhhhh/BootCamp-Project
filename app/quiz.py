...
QUIZ_RESULTS = {
    SYSTEM_GAP: QuizResult(
        ...
        (
            ...
            "На <b>BootCamp Open Week</b> мы покажем, из каких компонентов должна "
            "состоять торговая стратегия и как начать собирать её в рабочую структуру.\n\n"
            "До встречи с <b>1 по 5 июня</b> на просторах сервера."
        ),
    ),
    ROUTINE_GAP: QuizResult(
        ...
        (
            ...
            "На <b>BootCamp Open Week</b> мы разберём, как должна выглядеть торговая "
            "рутина: подготовка, принятие решений, открытие и закрытие сделок, "
            "запись сделок и анализ.\n\n"
            "До встречи с <b>1 по 5 июня</b> на просторах сервера."
        ),
    ),
    JOURNAL_GAP: QuizResult(
        ...
        (
            ...
            "час после появления следующей свечи. Как тогда анализировать рынок "
            "и как торговать?\n\n"
            "В таком режиме трейдер не только будет повторять одни и те же ошибки — "
            "вся торговля постепенно превращается в бесконтрольный и абстрактный процесс.\n\n"
            "На <b>BootCamp Open Week</b> мы покажем торговый журнал как инструмент "
            "анализа результата, метрик и своих преимуществ.\n\n"
            "До встречи с <b>1 по 5 июня</b> на просторах сервера."
        ),
    ),
    EXECUTION_GAP: QuizResult(
        ...
        (
            ...
            "правил и плана.\n\n"
            "Причин может быть много: от недостатка теоретических знаний или опыта "
            "до психологии и высокого уровня неопределенности в моменте.\n\n"
            "На <b>BootCamp Open Week</b> мы разберём, почему исполнение не держится "
            "только на силе воли и как система, рутина и журнал помогают снижать "
            "неопределенность в решениях.\n\n"
            "До встречи с <b>1 по 5 июня</b> на просторах сервера."
        ),
    ),
    PSYCHOLOGY_GAP: QuizResult(
        ...
        (
            ...
            "Важно понимать: такие реакции не говорят о слабом характере. Чаще всего "
            "они возникают, когда у трейдера недостаточно опоры в системе, рутине, "
            "правилах исполнения и регулярном разборе действий.\n\n"
            "На <b>BootCamp Open Week</b> мы покажем, как торговая система, рутина, "
            "журнал и правила исполнения помогают снизить эмоциональный шум и сделать "
            "поведение более управляемым.\n\n"
            "До встречи с <b>1 по 5 июня</b> на просторах сервера."
        ),
    ),
    NO_GAP: QuizResult(
        NO_GAP,
        "Ты на прямом пути к профессиональному трейдингу",
        (
            "<b>Ты на прямом пути к профессиональному трейдингу.</b>\n\n"
            "По ответам видно, что у тебя уже есть опора: система, рутина, журнал "
            "и контроль исполнения работают достаточно стабильно.\n\n"
            "Это не значит, что рост закончен. Наоборот, следующий этап — усиливать "
            "свои преимущества, точнее видеть метрики и постепенно повышать качество "
            "принятия решений.\n\n"
            "На <b>BootCamp Open Week</b> ты сможешь сверить свой процесс с подходом "
            "менторов, увидеть зоны для усиления и забрать идеи для следующего уровня.\n\n"
            "До встречи с <b>1 по 5 июня</b> на просторах сервера."
        ),
    ),
}
