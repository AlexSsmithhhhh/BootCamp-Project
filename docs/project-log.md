...
## 2026-05-20 - Упрощение preview flow `/post`

Запрос: убрать возможность редактировать пост из preview, оставить только подтверждение или отмену.

Что изменено:

- из preview-клавиатуры убрана кнопка `Редактировать`;
- после нажатия `Отправить`, `Запланировать`, `Отменить` или `Без кнопок` бот убирает inline-клавиатуру со старого сообщения;
- старые callback-и `Редактировать` из уже отправленных preview не возвращают draft в редактирование и предлагают начать заново через `/post`.
