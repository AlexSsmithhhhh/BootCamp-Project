...
- `/post` открывает меню `Пост сейчас`, `Рассылка сейчас`, `Запланировать`;
- `Пост сейчас` и `Рассылка сейчас` отправляют всем активным пользователям бота после preview/confirm;
