...
- Admin-команды Telegram и мастер `/post` для отправки постов/рассылок пользователям бота с preview, подтверждением, планированием, текстом, фото, альбомами, видео и PDF.
